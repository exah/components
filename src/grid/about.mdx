...
Here [`ThemeDefaultsProvider`](#/theme-defaults-provider) used to change defaults in runtime:

<Playground>
  <ThemeDefaultsProvider Grid={{ templateColumns: 'repeat(12, 1fr)', gap: 1 }}>
    <Grid>
      <Grid.Item column='span 1' pd={1} outline='1px solid'>
          1
      </Grid.Item>
...
Alternatively you can just create your own `Grid` component:
